...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2311f348750780ab84bbdb4b82e13b6e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'O0o-cry Page', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Learning to make changes', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://web-page-six-sigma.vercel.app/', // 网站地址
